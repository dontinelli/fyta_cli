...
class FytaSnapshotSerializer(AmberDataSerializer):
    """Fyta snapshot serializer for Syrupy.

    Handles special cases for Fyta data structures.
    """
...
class FytaSnapshotExtension(AmberSnapshotExtension):
    """Fyta extension for Syrupy."""
